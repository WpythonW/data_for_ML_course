...
| Меток | Entropy F1 | Random F1 | Δ F1 |
|-------|-----------|-----------|------|
| 250   | 0.6506 | 0.6506 | +0.000 |
| 500   | 0.7012 | 0.7089 | −0.008 |
| 750   | 0.7148 | 0.7059 | **+0.009** |
| 1,000 | 0.7376 | 0.7378 | −0.000 |
| 1,250 | 0.7510 | 0.7420 | **+0.009** |
| 1,500 | **0.7598** | 0.7496 | **+0.010** |

**Экономия: 250 меток (16.7%)** — entropy достигает финального F1 random (0.750) уже при 1,250 метках.
