...
![learning_curve_balanced](docs/learning_curve_balanced.png)

| Меток | Entropy F1 | Random F1 | Δ F1 |
|-------|-----------|-----------|------|
| 50    | 0.349 | 0.349 | 0.000 |
| 300   | 0.351 | 0.488 | **−0.137** |
| 550   | 0.574 | 0.613 | −0.039 |
| 800   | 0.644 | 0.621 | +0.023 |
| 1,300 | 0.681 | 0.651 | +0.029 |
| 1,800 | 0.686 | 0.686 | ≈0.000 |
| 2,800 | 0.713 | 0.712 | +0.002 |

**Экономия: 0 меток** — при идеальном балансе кривые сходятся, entropy не даёт преимущества.
