...
| 250   | 0.5713 | 0.5713 | +0.000 |
| 500   | 0.6684 | 0.6789 | −0.010 |
| 750   | 0.7141 | 0.6911 | **+0.023** |
| 1,000 | 0.7567 | 0.7209 | **+0.036** |
| 1,250 | 0.7798 | 0.7482 | **+0.032** |
| 1,500 | **0.7928** | 0.7523 | **+0.040** |

**Экономия: ~250 меток** — с 750 меток entropy стабильно опережает random на +0.023–0.040 F1.
